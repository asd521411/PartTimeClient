...
- (instancetype)init {
    ...
    if (self) {
        ...
        _lineColor = [ECUtil colorWithHexString:@"343434"];
        _converColor = [UIColor cyanColor];
        _addButtonBackgroundColor = [UIColor whiteColor];
        _bottomLineBgColor = [UIColor whiteColor];
        _scrollViewBackgroundColor = [UIColor whiteColor];
        _normalItemColor = [UIColor grayColor];
        _selectedItemColor = [ECUtil colorWithHexString:@"343434"];
        _lineHeight = 0.5;
        _converHeight = 28;
