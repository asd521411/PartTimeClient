//
//  PomeloCommonTableViewController.m
//  PartTime
//
...
@interface PomeloCommonTableViewController ()

@property (nonatomic, strong) NSMutableArray *listArr;

@end

@implementation PomeloCommonTableViewController
...
- (void)loadData {
    ...
    NSDictionary *para = @{@"userid":[ECUtil isBlankString:userid]?@"":userid, @"selectPayType":@"看过我"};
