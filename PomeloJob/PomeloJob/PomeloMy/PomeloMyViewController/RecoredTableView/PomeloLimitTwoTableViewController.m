//
//  PomeloLimitTwoTableViewController.m
//  PartTime
//
...
@interface PomeloLimitTwoTableViewController ()
...
@implementation PomeloLimitTwoTableViewController
...
- (void)loadData {
    ...
    NSDictionary *para = @{@"userid":[ECUtil isBlankString:userid]?@"":userid, @"relationtype":@"我看过"};
