...
- (void)configSubViews {
    ...
    [self.tableView1 registerClass:[LocationTableViewCell class] forCellReuseIdentifier:@"LocationTableViewCell"];
    ...
    [self.tableView2 registerClass:[LocationTableViewCell class] forCellReuseIdentifier:@"LocationTableViewCell"];
...
//        self.selectInteger1 = indexPath.row;
//        [self.dataArr2 removeAllObjects];
//        NSArray *arr = self.dataArr1[indexPath.row];
//        self.dataArr2 = [NSMutableArray arrayWithArray:arr];
