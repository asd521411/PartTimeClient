...
- (void)viewDidLoad {
    ...
    flowLayout.itemSize = CGSizeMake(SpaceDistance100, SpaceDistance100);
    ...
    self.collectionView.backgroundColor = [HWRandomColor randomColor];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backgroundColor = [HWRandomColor randomColor];
    // Configure the cell
